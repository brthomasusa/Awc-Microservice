...
namespace PersonData.IntegrationTests.Data;

public static class PersonTestData
{

    public static Result<Person> GetValidNewPersonAggregate()
    {
        ...
        person.Value.AddEmailAddress(new PersonEmailAddressID(0), "david0@adventure-works.com");
        person.Value.AddPhoneNumber(new PersonPhoneID(0), AWC.PersonData.API.Domain.PersonAggregate.Enums.PhoneNumberType.Cell, "913-555-0172");
    ...
    public static UpdatePersonCommand GetUpdatePesonCommand()
    {
        return new(
                BusinessEntityID: 16,
                PersonType: "EM",
                ...
                EmailAddresses:
                [
                    new EmailAddressDto(){ EmailAddressID = 16, MailAddress = "david0@adventure-works.com" }
                ],
                Telephones:
                [
                    new PersonPhoneDto() {PhoneNumber = "913-321-0172", PhoneNumberTypeID = 2}
                ],
                Addresses:
                [
                    new AddressDto()
