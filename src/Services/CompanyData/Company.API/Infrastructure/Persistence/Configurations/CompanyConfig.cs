...
{
    internal class CompanyConfig : IEntityTypeConfiguration<AWC.Company.API.Infrastructure.Persistence.DataModels.Company>
    {
        public void Configure(EntityTypeBuilder<AWC.Company.API.Infrastructure.Persistence.DataModels.Company> entity)
        {
            ...
            entity.HasData
            (
                new AWC.Company.API.Infrastructure.Persistence.DataModels.Company()
                {
                    CompanyID = 1,
